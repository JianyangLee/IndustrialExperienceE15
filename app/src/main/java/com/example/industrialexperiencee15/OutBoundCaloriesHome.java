...
public class OutBoundCaloriesHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_bound_calories_home);
        ...
        OutBoundCaloriesHome.DBInAsyncTask dbReadin = new OutBoundCaloriesHome.DBInAsyncTask();
        dbReadin.execute();

        final Button exerciseTracker = (Button) findViewById(R.id.btnTileEnterUserExerises);
        final Button trackUserExercises = (Button) findViewById(R.id.btnTileViewUserExercises);
        ...
        exerciseTracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent addExcerises = new Intent(OutBoundCaloriesHome.this, activity_exercise.class);
                OutBoundCaloriesHome.this.startActivity(addExcerises);
            }
        });
        trackUserExercises.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent viewExerises = new Intent(OutBoundCaloriesHome.this, TrackFood.class);
                OutBoundCaloriesHome.this.startActivity(viewExerises);
            }
        });
...
//                    int userCalorieLimitForTheDay =userSharedPreferenceDetails.getInt("calorieLimit",0);
                    ...
                    OutBoundCaloriesHome.ShowAsyncTask show = new OutBoundCaloriesHome.ShowAsyncTask();
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_food:
                    Intent intent_Tracker = new Intent(OutBoundCaloriesHome.this, Tracker.class);
                    startActivity(intent_Tracker);
                    return true;
                case R.id.navigation_dashboard:
                    Intent intent_activity_exercise = new Intent(OutBoundCaloriesHome.this, Dashboard.class);
                    startActivity(intent_activity_exercise);
                    ;
                    return true;
                case R.id.navigation_exercise:
                    Intent intent_Dashboard = new Intent(OutBoundCaloriesHome.this, activity_exercise.class);
                    startActivity(intent_Dashboard);
                    return true;
                case R.id.navigation_settings:
                    Intent intent_Settings = new Intent(OutBoundCaloriesHome.this, UserSettingsHome.class);
