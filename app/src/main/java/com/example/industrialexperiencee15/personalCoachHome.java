...
public class personalCoachHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_coach_home);
        ...
        personalCoachHome.DBInAsyncTask dbReadin = new personalCoachHome.DBInAsyncTask();
        dbReadin.execute();

        final Button foodCoach = (Button) findViewById(R.id.btnTileUserFoodCoach);
        final Button sportsCoach = (Button) findViewById(R.id.btnTileUserSportsCoach);
        ...
        sportsCoach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent viewExerises = new Intent(personalCoachHome.this, sportsCoach.class);
                personalCoachHome.this.startActivity(viewExerises);
            }
        });
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_food:
                    Intent intent_Tracker = new Intent(personalCoachHome.this, Tracker.class);
                    startActivity(intent_Tracker);
                    return true;
                case R.id.navigation_dashboard:
                    Intent intent_activity_exercise = new Intent(personalCoachHome.this, Dashboard.class);
                    startActivity(intent_activity_exercise);
                    ;
                    return true;
                case R.id.navigation_exercise:
                    Intent intent_Dashboard = new Intent(personalCoachHome.this, activity_exercise.class);
                    startActivity(intent_Dashboard);
                    return true;
                case R.id.navigation_settings:
                    Intent intent_Settings = new Intent(personalCoachHome.this, UserSettingsHome.class);
...
//                    int userCalorieLimitForTheDay =userSharedPreferenceDetails.getInt("calorieLimit",0);
                    ...
                    personalCoachHome.ShowAsyncTask show = new personalCoachHome.ShowAsyncTask();
